...
var IconsInfo = []IconInfo{
	...
	},
	{
		Name:       "Apple",
		Icon:       Apple,
		Tags:       []string{"fruit", "food", "healthy", "snack", "nutrition", "fresh", "produce", "grocery", "organic", "harvest", "vitamin", "red", "green", "juicy", "sweet", "tart", "bite", "orchard", "plant", "core", "raw", "diet"},
	...
	},
	{
		...
		Categories: []string{"arrows", "gaming", "files"},
	},
	{
		Name:       "Arrow Big Down",
		Icon:       ArrowBigDown,
		Tags:       []string{"backwards", "reverse", "direction", "south"},
		Categories: []string{"arrows", "gaming"},
	},
	{
	...
	},
	{
		...
		Categories: []string{"arrows", "text", "development", "gaming"},
	},
	{
		Name:       "Arrow Big Up",
		Icon:       ArrowBigUp,
	...
	},
	{
		...
		Categories: []string{"arrows", "files", "development"},
	},
	{
		Name:       "Arrow Down Up",
		Icon:       ArrowDownUp,
	...
	},
	{
		Name:       "Balloon",
		Icon:       Balloon,
		Tags:       []string{"party", "festival", "congratulations", "celebration", "decoration", "colorful", "floating", "fun", "birthday", "event", "entertainment"},
		Categories: []string{"emoji"},
	},
	{
		Name:       "Ban",
	...
	},
	{
		Name:       "Birdhouse",
		Icon:       Birdhouse,
		Tags:       []string{"birdhouse", "bird", "garden", "home", "house", "woodwork"},
		Categories: []string{"nature", "animals", "navigation", "home"},
	},
	{
		Name:       "Bitcoin",
		Icon:       Bitcoin,
	...
	},
	{
		Name:       "Book Search",
		Icon:       BookSearch,
		Tags:       []string{"reading", "library", "study", "education", "research", "knowledge", "discover", "browsing", "lookup", "finding", "scanning"},
		Categories: []string{"text", "development", "gaming"},
	},
	{
		Name:       "Book Text",
	...
	},
	{
		...
		Tags:       []string{"firewall", "security", "bricks", "mortar", "cement", "materials", "construction", "builder", "labourer", "quantity surveyor", "blocks", "stone", "cybersecurity", "secure", "safety", "protection", "guardian", "armored", "armoured", "defense", "defence", "defender", "block", "threat", "prevention", "antivirus", "vigilance", "vigilant", "detection", "scan", "find", "strength", "strong", "tough", "invincible", "invincibility", "invulnerable", "undamaged", "audit", "admin", "verification", "crest", "bravery", "knight", "foot soldier", "infantry", "trooper", "pawn", "battle", "war", "military", "army", "cadet", "scout"},
		Categories: []string{"security", "home", "connectivity"},
	},
	{
		Name:       "Brick Wall",
	...
	},
	{
		Name:       "Bug Off",
		Icon:       BugOff,
		Tags:       []string{"issue", "fixed", "resolved", "testing", "debug", "code", "insect", "kill", "exterminate", "pest control"},
		Categories: []string{"development", "animals"},
	},
	{
		Name:       "Bug Play",
		Icon:       BugPlay,
		Tags:       []string{"issue", "testing", "debug", "reproduce", "code", "insect"},
		Categories: []string{"development", "animals"},
	},
	{
		Name:       "Bug",
		Icon:       Bug,
		Tags:       []string{"issue", "error", "defect", "testing", "troubleshoot", "problem", "report", "debug", "code", "insect", "beetle"},
		Categories: []string{"development", "animals"},
	},
	{
		Name:       "Building 2",
	...
	},
	{
		Name:       "Calendars",
		Icon:       Calendars,
		Tags:       []string{"date", "month", "year", "event", "dates", "months", "years", "events"},
		Categories: []string{"time"},
	},
	{
		Name:       "Camera Off",
	...
	},
	{
		Name:       "Camera",
		Icon:       Camera,
		Tags:       []string{"photography", "lens", "focus", "capture", "shot", "visual", "image", "device", "equipment", "photo", "webcam", "video"},
		Categories: []string{"photography", "devices", "communication"},
	},
	{
		Name:       "Candy Cane",
	...
	},
	{
		...
		Categories: []string{"buildings", "gaming", "navigation"},
	},
	{
		Name:       "Cat",
		Icon:       Cat,
	...
	},
	{
		Name:       "Chess Bishop",
		Icon:       ChessBishop,
		Tags:       []string{"mitre", "miter", "piece", "board game", "religion"},
		Categories: []string{"gaming", "emoji"},
	},
	{
		Name:       "Chess King",
		Icon:       ChessKing,
		Tags:       []string{"ruler", "crown", "piece", "board game", "stalemate"},
		Categories: []string{"gaming", "emoji"},
	},
	{
		Name:       "Chess Knight",
		Icon:       ChessKnight,
		Tags:       []string{"piece", "horse", "board game"},
		Categories: []string{"gaming", "emoji"},
	},
	{
		Name:       "Chess Pawn",
		Icon:       ChessPawn,
		Tags:       []string{"piece", "board game"},
		Categories: []string{"gaming", "emoji"},
	},
	{
		Name:       "Chess Queen",
	...
	},
	{
		Name:       "Chess Rook",
		Icon:       ChessRook,
		Tags:       []string{"castle", "piece", "board game"},
		Categories: []string{"gaming", "emoji"},
	},
	{
		Name:       "Chevron Down",
	...
	},
	{
		Name:       "Circle Pile",
		Icon:       CirclePile,
		Tags:       []string{"off", "zero", "record", "shape", "circle-pile", "circle", "pile", "stack", "layer", "structure", "form", "group", "collection", "stock", "inventory", "materials", "warehouse"},
		Categories: []string{"shapes"},
	},
	{
		Name:       "Circle Play",
	...
	},
	{
		Name:       "Circle Star",
		Icon:       CircleStar,
		Tags:       []string{"badge", "medal", "honour", "decoration", "order", "pin", "laurel", "trophy", "medallion", "insignia", "bronze", "silver", "gold"},
	...
	},
	{
		Name:       "Cloud Backup",
		Icon:       CloudBackup,
		Tags:       []string{"storage", "memory", "bytes", "servers", "backup", "timemachine", "rotate", "synchronize", "synchronise", "refresh", "reconnect", "transfer", "data", "security", "upload", "save", "remote", "safety"},
		Categories: []string{"arrows", "files"},
	},
	{
		Name:       "Cloud Check",
	...
	},
	{
		Name:       "Cloud Sync",
		Icon:       CloudSync,
		Tags:       []string{"synchronize", "synchronise", "refresh", "reconnect", "transfer", "backup", "storage", "upload", "download", "connection", "network", "data"},
		Categories: []string{"arrows", "files"},
	},
	{
		Name:       "Cloud Upload",
	...
	},
	{
		...
		Categories: []string{"buildings", "sustainability", "navigation"},
	},
	{
	...
	},
	{
		Name:       "Ev Charger",
		Icon:       EvCharger,
		Tags:       []string{"electric", "charger", "station", "vehicle", "fast", "plug", "ev", "power", "electricity", "energy", "accumulator", "charge"},
		Categories: []string{"transportation", "navigation"},
	},
	{
		Name:       "Expand",
	...
	},
	{
		Name:       "Fishing Hook",
		Icon:       FishingHook,
		Tags:       []string{"sea", "boating", "angler", "bait", "reel", "tackle", "marine", "outdoors", "fish", "fishing", "hook", "sports", "travel"},
		Categories: []string{"sports", "travel"},
	},
	{
		Name:       "Flag Off",
		Icon:       FlagOff,
	...
	},
	{
		Name:       "Flame",
		Icon:       Flame,
		Tags:       []string{"heat", "burn", "light", "glow", "ignite", "passion", "ember", "fire", "lit", "burning", "spark", "embers", "smoke", "firefighter", "fireman", "department", "brigade", "station", "emergency"},
		Categories: []string{"weather", "social", "gaming"},
	},
	{
		Name:       "Flashlight Off",
		Icon:       FlashlightOff,
		Tags:       []string{"torch", "light", "beam", "emergency", "safety", "tool", "bright"},
	...
	},
	{
		Name:       "Form",
		Icon:       Form,
		Tags:       []string{"document", "page", "file", "layout", "paper", "stub", "formality", "structure", "template", "inputs", "design", "components"},
		Categories: []string{"development"},
	},
	{
		Name:       "Forward",
	...
	},
	{
		...
		Tags:       []string{"direction", "arrow", "controller", "navigation", "button", "move", "pointer", "arrowhead", "console", "game", "gaming"},
		Categories: []string{"gaming", "devices"},
	},
	{
		Name:       "Gamepad",
	...
	},
	{
		...
		Icon:       GitBranchMinus,
		Tags:       []string{"code", "version control", "vcs", "repository", "delete", "remove", "-"},
		Categories: []string{"development"},
	},
	{
		Name:       "Git Branch Plus",
		Icon:       GitBranchPlus,
		Tags:       []string{"code", "version control", "vcs", "repository", "add", "create", "+"},
		Categories: []string{"development"},
	},
	{
		Name:       "Git Branch",
		Icon:       GitBranch,
		Tags:       []string{"code", "version control", "vcs", "repository"},
		Categories: []string{"development"},
	},
	{
	...
	},
	{
		Name:       "Hd",
		Icon:       Hd,
		Tags:       []string{"tv", "resolution", "video", "high definition", "720p", "1080p"},
		Categories: []string{"devices", "multimedia"},
	},
	{
		Name:       "Hdmi Port",
	...
	},
	{
		Name:       "Helicopter",
		Icon:       Helicopter,
		Tags:       []string{"transport", "flying", "rotor", "aviation", "helipad", "gear", "flyer", "technology", "helicopter", "aircraft", "vehicle"},
		Categories: []string{"transportation", "travel"},
	},
	{
		Name:       "Hexagon",
	...
	},
	{
		Name:       "House Heart",
		Icon:       HouseHeart,
		Tags:       []string{"home sweet home", "abode", "building", "residence", "healthy living", "lifestyle"},
		Categories: []string{"home", "buildings", "medical"},
	},
	{
		Name:       "House Plug",
		Icon:       HousePlug,
	...
	},
	{
		...
		Categories: []string{"buildings", "home", "navigation"},
	},
	{
		Name:       "Ice Cream Bowl",
		Icon:       IceCreamBowl,
	...
	},
	{
		...
		Icon:       IdCardLanyard,
		Tags:       []string{"id-card", "id-card-lanyard", "identity", "employee", "gate-pass", "badge"},
	...
	},
	{
		Name:       "Kayak",
		Icon:       Kayak,
		Tags:       []string{"kayak", "boat", "paddle", "water", "sport", "recreation", "adventure", "outdoors", "equipment", "lake", "ocean"},
		Categories: []string{"transportation"},
	},
	{
		Name:       "Key Round",
	...
	},
	{
		Name:       "Layers Plus",
		Icon:       LayersPlus,
		Tags:       []string{"stack", "layers", "add", "new", "increase", "create", "positive", "copy", "upgrade"},
		Categories: []string{"design", "layout"},
	},
	{
		Name:       "Layers",
	...
	},
	{
		...
		Tags:       []string{"options", "items", "collapse", "expand", "details", "disclosure", "show", "hide", "toggle", "accordion", "more", "less", "fold", "unfold", "vertical"},
		Categories: []string{"text", "arrows"},
	},
	{
	...
	},
	{
		...
		Icon:       MessagesSquare,
		Tags:       []string{"comment", "chat", "conversation", "dialog", "feedback", "speech bubbles", "copy", "multiple", "discussion", "interview", "debate"},
		Categories: []string{"social"},
	},
	{
		Name:       "Mic Off",
	...
	},
	{
		Name:       "Monitor Cloud",
		Icon:       MonitorCloud,
		Tags:       []string{"virtual machine", "virtual desktop", "vm", "vdi", "computing", "remote work", "monitoring", "infrastructure", "software as a service", "saas", "workstation", "environment", "tv", "screen", "display"},
	...
	},
	{
		Name:       "Motorbike",
		Icon:       Motorbike,
		Tags:       []string{"moto", "motorcycle", "transport", "vehicle", "drive", "ride", "trip", "race", "racing", "journey", "delivery"},
		Categories: []string{"transportation"},
	},
	{
		Name:       "Mountain Snow",
	...
	},
	{
		...
		Tags:       []string{"pointer", "mouse", "cursor", "off", "disable", "arrow", "navigation", "selection", "select", "click", "no-click", "interaction"},
	...
	},
	{
		...
		Tags:       []string{"drawer", "dock", "show", "reveal", "padding", "margin", "guide", "layout", "bleed"},
		Categories: []string{"layout"},
	},
	{
	...
	},
	{
		...
		Tags:       []string{"sidebar", "primary", "drawer", "show", "reveal", "padding", "margin", "guide", "layout", "bleed"},
		Categories: []string{"layout"},
	},
	{
	...
	},
	{
		...
		Tags:       []string{"sidebar", "primary", "drawer", "show", "reveal", "padding", "margin", "guide", "layout", "vertical", "bleed"},
		Categories: []string{"layout"},
	},
	{
		Name:       "Panel Left",
	...
	},
	{
		...
		Tags:       []string{"sidebar", "secondary", "drawer", "show", "reveal", "padding", "margin", "guide", "layout", "bleed"},
		Categories: []string{"layout"},
	},
	{
	...
	},
	{
		...
		Tags:       []string{"sidebar", "primary", "drawer", "show", "reveal", "padding", "margin", "guide", "layout", "horizontal", "bleed"},
		Categories: []string{"layout"},
	},
	{
	...
	},
	{
		...
		Icon:       PanelTopDashed,
		Tags:       []string{"menu bar", "drawer", "show", "reveal", "padding", "margin", "guide", "layout", "bleed"},
		Categories: []string{"layout"},
	},
	{
		Name:       "Panel Top Open",
	...
	},
	{
		...
		Categories: []string{"transportation", "travel", "navigation"},
	},
	{
		Name:       "Play",
		Icon:       Play,
	...
	},
	{
		Name:       "Plug",
		Icon:       Plug,
		Tags:       []string{"electricity", "energy", "electronics", "socket", "outlet", "power", "voltage", "current", "charger"},
		Categories: []string{"devices", "development"},
	},
	{
		Name:       "Plus",
	...
	},
	{
		Name:       "Rose",
		Icon:       Rose,
		Tags:       []string{"roses", "thorns", "petals", "plant", "stem", "leaves", "spring", "bloom", "blossom", "gardening", "botanical", "flora", "florist", "bouquet", "bunch", "gift", "date", "romance", "romantic", "valentines day", "special occasion"},
		Categories: []string{"nature", "seasons", "sustainability", "home", "social"},
	},
	{
		Name:       "Rotate 3d",
		Icon:       Rotate3d,
	...
	},
	{
		Name:       "Scale",
		Icon:       Scale,
		Tags:       []string{"balance", "legal", "license", "right", "rule", "law", "justice", "weight", "measure", "compare", "judge", "fair", "ethics", "decision"},
		Categories: []string{"navigation", "science", "finance"},
	},
	{
		Name:       "Scaling",
		Icon:       Scaling,
	...
	},
	{
		Name:       "Scooter",
		Icon:       Scooter,
		Tags:       []string{"vehicle", "drive", "trip", "journey", "transport", "electric", "ride", "urban", "commute", "speed"},
		Categories: []string{"transportation"},
	},
	{
	...
	},
	{
		Name:       "Search Alert",
		Icon:       SearchAlert,
		Tags:       []string{"find", "scan", "magnifier", "magnifying glass", "stop", "warning", "alert", "error", "anomaly", "lens"},
		Categories: []string{"text", "social"},
	},
	{
		Name:       "Search Check",
	...
	},
	{
		Name:       "Ship",
		Icon:       Ship,
		Tags:       []string{"boat", "knots", "nautical mile", "maritime", "sailing", "yacht", "cruise", "ocean liner", "tanker", "vessel", "navy", "trip", "releases"},
		Categories: []string{"transportation", "navigation", "travel"},
	},
	{
		Name:       "Shirt",
	...
	},
	{
		Name:       "Solar Panel",
		Icon:       SolarPanel,
		Tags:       []string{"solar panel", "solar", "panel", "sun", "energy", "electricity", "light"},
		Categories: []string{"home", "science", "sustainability", "weather"},
	},
	{
		Name:       "Soup",
		Icon:       Soup,
	...
	},
	{
		...
		Categories: []string{"arrows", "social"},
	},
	{
	...
	},
	{
		Name:       "Stone",
		Icon:       Stone,
		Tags:       []string{"mineral", "geology", "nature", "solid", "pebble", "crystal", "ore", "hard", "coal", "stone", "rock", "boulder"},
		Categories: []string{"nature"},
	},
	{
		Name:       "Store",
	...
	},
	{
		Name:       "Toolbox",
		Icon:       Toolbox,
		Tags:       []string{"toolkit", "tools", "trunk", "chest", "box", "storage", "utility", "utilities", "container", "kit", "set", "repair", "fix", "service", "maintenance", "mechanic", "workshop", "construction", "hardware", "equipment", "gear", "handyman", "engineering", "craft", "diy"},
		Categories: []string{"tools", "home"},
	},
	{
		Name:       "Tornado",
	...
	},
	{
		Name:       "Van",
		Icon:       Van,
		Tags:       []string{"minivan", "cart", "wagon", "truck", "lorry", "trailer", "camper", "vehicle", "drive", "trip", "journey", "van", "transport", "carriage", "delivery", "travel"},
		Categories: []string{"transportation"},
	},
	{
		Name:       "Variable",
	...
	},
	{
		Name:       "Wallpaper",
		Icon:       Wallpaper,
		Tags:       []string{"background", "texture", "image", "art", "design", "visual", "decor", "pattern", "screen", "cover", "lock screen"},
	...
	},
	{
		...
		Icon:       WavesArrowDown,
		Tags:       []string{"water", "sea", "level", "sound", "hertz", "wavelength", "vibrate", "low", "tide", "ocean", "rising", "down", "falling"},
		Categories: []string{"weather", "sustainability"},
	},
	{
		Name:       "Waves Arrow Up",
		Icon:       WavesArrowUp,
		Tags:       []string{"water", "sea", "level", "sound", "hertz", "wavelength", "vibrate", "high", "tide", "ocean", "rising"},
		Categories: []string{"weather", "sustainability"},
	},
	{
		Name:       "Waves Ladder",
	...
	},
	{
		Name:       "Weight Tilde",
		Icon:       WeightTilde,
		Tags:       []string{"measure", "scale", "estimate", "load", "balance", "size", "measurement", "quantity", "mass"},
		Categories: []string{"math"},
	},
	{
		Name:       "Weight",
